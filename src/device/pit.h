...
public:
    ...
    int current_count = 0; // from 0 to PIT_TARGET_FREQUECY oh and i hate c++ getteur and setteur as it is so bad for optimization (or compile time) so nyeh :^( it is public value
    void update();
    void init_PIT();
