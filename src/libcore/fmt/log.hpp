...
#ifndef NO_LOG_COLOR
#define log$(...) log("\033[95m[{}:{}]:\033[0m ", __LOG_FILENAME__, __LINE__); log::log(__VA_ARGS__); log::log("\n")

#else 
#define log$(...) log("[{}:{}]: ", __LOG_FILENAME__, __LINE__); log::log(__VA_ARGS__); log::log("\n")
...
constexpr void core::Result<ValT, ErrT>::assert() 
{
    if (_error.has_value())
    {
